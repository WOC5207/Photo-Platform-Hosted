...
async function main() {
  ...
  let layoutVersion = 1;
  let slots = parseCosplanSlots([40, 290, 540].map((x, index) => ({ id: `slot-${index + 1}`, nameEn: ["Friday", "Saturday", "Sunday"][index], nameZh: ["周五", "周六", "周日"][index], x, y: 220, width: 220, height: 580 })), 800, 1000);
