...
export default async function AdminEventsPage({
  ...
  const [events, legacyBookings, eventTotal, legacyTotal] = await Promise.all([
    ...
    prisma.bookingEvent.count({ where: { ownerId: user.id, galleryEventId: null } })
  ]);
  const total = eventTotal + legacyTotal;
