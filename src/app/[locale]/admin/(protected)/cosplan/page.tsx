...
export default async function CosplanAdminPage() {
  ...
  const slotLabels = {
    ...
    nameText: t("nameText"), nameTextHint: t("nameTextHint"), enableNameText: t("enableNameText"),
    fontSize: t("nameFontSize"), textColor: t("nameTextColor"), textAlign: t("nameTextAlign"),
    alignLeft: t("nameAlignLeft"), alignCenter: t("nameAlignCenter"), alignRight: t("nameAlignRight"), boldText: t("nameBold"),
